...
class view_update_ecard:
    """View layer for E-card QR update flow. Type-specific URLs (no qr_type param)."""
    ...
    def update_qr_content_html(self, qrcard, url_content=None, qr_name=None, short_code=None, msg=None, error_msg=None, base_url=None):
        ...
        try:
            ...
            return render_template(
                "/user/edit_qr_content_ecard.html",
                qr_type="ecard",
                qrcard_id=cid,
                qrcard=qrcard,
                ...
                back_url="/qr/list",
                step1_url="/qr/list",
                step3_url="/qr/update/ecard/qr-design/{}".format(cid),
                is_update=True,
                msg=msg,
                base_url=base_url,
                error_msg=error_msg,
            ...
            return "Failed to load Update QR Content (E-card)"
    ...
    def update_qr_design_html(self, qrcard, url_content=None, qr_name=None, qr_encode_url=None, msg=None, error_msg=None):
        ...
        try:
            ...
            return render_template(
                ...
                form_action="/qr/update/save/ecard/{}".format(cid),
                back_url="/qr/update/ecard/{}".format(cid),
                step1_url="/qr/list",
                step2_url="/qr/update/ecard/{}".format(cid),
                is_update=True,
                msg=msg,
                error_msg=error_msg,
            )
            ...
            if self.webapp:
                self.webapp.logger.debug(traceback.format_exc())
            return "Failed to load Update QR Design (E-card)"
