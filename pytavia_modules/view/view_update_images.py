...
class view_update_images:
    """View layer for Images QR update flow. Type-specific URLs."""
    ...
    def update_qr_content_html(self, qrcard, url_content=None, qr_name=None, short_code=None, msg=None, error_msg=None, base_url=None):
        """Step 1 (content): edit_qr_content_images.html."""
        try:
            ...
            return render_template(
                "/user/edit_qr_content_images.html",
                qr_type="images",
                qrcard_id=cid,
                qrcard=qrcard,
                ...
                back_url="/qr/list",
                step1_url="/qr/list",
                step3_url="/qr/update/images/qr-design/{}".format(cid),
                is_update=True,
                msg=msg,
                base_url=base_url,
                error_msg=error_msg,
            ...
            return "Failed to load Update QR Content (Images)"
    ...
    def update_qr_design_html(self, qrcard, url_content=None, qr_name=None, qr_encode_url=None, msg=None, error_msg=None):
        ...
        try:
            ...
            return render_template(
                ...
                form_action="/qr/update/save/images/{}".format(cid),
                back_url="/qr/update/images/{}".format(cid),
                step1_url="/qr/list",
                step2_url="/qr/update/images/{}".format(cid),
                is_update=True,
                msg=msg,
                error_msg=error_msg,
            )
            ...
            if self.webapp:
                self.webapp.logger.debug(traceback.format_exc())
            return "Failed to load Update QR Design (Images)"
